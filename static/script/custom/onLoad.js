...
Global Variables
-----------------------------------*/
var languages = ["Words", "Meaning", "transcribed"],
    language = "Words",
    category = "All",
    correct = 0,
    wrong = 0,
...
function resizeText(cardNo, ft, bt1, bt2) {
    // Words does not need to be resized
    if (language != "Words") {
        if (ft.length > 11) {
    ...
    // Second back text is never Words and always needs to be resized
    if (bt2.length > 11) {
